...
<section
	...
	style="background: url('/images/a-website/bg-news.png')no-repeat bottom right"
>
	<div class="container">
		<div class="row">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 col-md-12">
				<div class="single-article feature-article rounded-custom my-3">
					...
					<div class="article-content p-4">
						...
						<a href="news/1">
							<h2 class="h5 article-title limit-3-line-text">
								การบริหารจัดการเพื่อรองรับกรณีการเกิดเหตุฉุกเฉินจากการขนส่งสินค้าอันตรายทางถนน
							</h2>
						</a>
						<p class="limit-2-line-text">
							การประเมินระดับความรุนแรงกรณีเกิดเหตุการณ์ฉุกเฉินจากการขนส่งสินค้าอันตรายทางถนน
							จำเป็นต้องค้นหาสาเหตุของเหตุการณ์และเร่งยับยั้งไม่ให้เกิดเหตุการณ์ที่บานปลายหรือลุกลาม
							มากกว่าที่ควรจะเป็นแต่ถ้าจะให้การจัดการเหตุฉุกเฉินเป็นไปอย่างมีระบบ
						</p>
					</div>
				</div>
			</div>
			<div class="col-lg-6 col-md-12">
				<div class="single-article feature-article rounded-custom my-3">
					<a href="blog-single.html" class="article-img">
						<img src="/images/detail/detail_demo2.jpeg" alt="article" class="img-fluid" />
					</a>
					<div class="article-content p-4">
						<div class="article-category mb-4 d-block">
		...
		<div class="row">
			<div class="col-lg-4 col-md-6">
				<div class="single-article rounded-custom my-3">
					<a href="blog-single.html" class="article-img">
						<img src="/images/detail/detail_demo3.jpeg" alt="article" class="img-fluid" />
					</a>
					<div class="article-content p-4">
						<div class="article-category mb-4 d-block">
			...
			<div class="col-lg-4 col-md-6">
				<div class="single-article rounded-custom my-3">
					<a href="blog-single.html" class="article-img">
						<img src="/images/detail/detail_demo4.jpeg" alt="article" class="img-fluid" />
					</a>
					<div class="article-content p-4">
						<div class="article-category mb-4 d-block">
							<a href="javascript:;" class="d-inline-block text-primary badge bg-primary-soft">
			...
			<div class="col-lg-4 col-md-6">
				<div class="single-article rounded-custom my-3">
					<a href="blog-single.html" class="article-img">
						<img src="/images/detail/detail_demo5.jpeg" alt="article" class="img-fluid" />
					</a>
					<div class="article-content p-4">
						<div class="article-category mb-4 d-block">
							<a href="javascript:;" class="d-inline-block text-danger badge bg-danger-soft">
