<footer class="footer-section">
	...
	<div
		class="footer-top bg-dark text-white ptb-120"
		style="background: url('/images/page-header-bg.svg')no-repeat bottom right"
	>
		<div class="container">
						...
						<!-- <div class="col-md-4 col-lg-4 mt-4 mt-md-0 mt-lg-0">
							<div class="footer-single-col">
								...
								<ul class="list-unstyled footer-nav-list mb-lg-0">
									...
									<li>
										<a href="career-single.html" class="text-decoration-none">Career Single</a>
									</li>
									<li>
										<a href="service-single.html" class="text-decoration-none">Services Single</a>
									</li>
								</ul>
							</div>
						</div> -->
						<!-- <div class="col-md-4 col-lg-4 mt-4 mt-md-0 mt-lg-0">
							<div class="footer-single-col">
								...
								<ul class="list-unstyled footer-nav-list mb-lg-0">
									...
									<li>
										<a href="support-single.html" class="text-decoration-none">Support Single</a>
									</li>
									<li><a href="team.html" class="text-decoration-none">Our Team</a></li>
									<li>
										<a href="client-review.html" class="text-decoration-none">Customer Review</a>
									</li>
									<li>
										<a href="career-single.html" class="text-decoration-none">Career Single</a>
									</li>
				...
				<div class="col-md-7 col-lg-7">
					<div class="copyright-text">
						<p class="mb-lg-0 mb-md-0">
							&copy; 2021 Quiety Rights Reserved. Designed By <a
								href="https://themetags.com/"
								class="text-decoration-none">ThemeTags</a
							>
						</p>
					</div>
				</div>
